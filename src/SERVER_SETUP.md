...
- Streamlit App: http://35.225.103.170:8501	(No login)
- Airflow UI: http://35.225.103.170:8080	- User: airflow/password: airflow
- MLflow UI: http://35.225.103.170:5500	(No login)
- Flower (Celery): http://35.225.103.170:5555	(No login)
- Kafka UI: http://35.225.103.170:8082	(No login)
- Minio UI - http://35.225.103.170:9001/login User: minioadmin/password: minioadmin
